// Uses Node's built-in SQLite (Node 22+), so there is NOTHING to compile —
// no Visual Studio / C++ build tools needed. Run with the --experimental-sqlite
// flag (already set in package.json scripts).
...
// Thin adapter so the rest of the app keeps the familiar
// db.prepare(...).run/get/all and db.exec(...) API.
const db = {
